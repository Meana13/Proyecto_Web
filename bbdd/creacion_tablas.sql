...
ALTER TABLE `sondas`
  ...
  ADD KEY `fk_id_huerto_sondas` (`id_huerto`);
...
--
ALTER TABLE `mediciones`
    MODIFY `id_medicion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1141;
...
--
ALTER TABLE `mediciones`
    ADD CONSTRAINT `fk_sonda2` FOREIGN KEY (`id_sonda`) REFERENCES `sondas` (`id_sonda`);
...
--
ALTER TABLE `sondas`
    ADD CONSTRAINT `fk_id_huerto_sondas` FOREIGN KEY (`id_huerto`) REFERENCES `huertos` (`id_huerto`);
